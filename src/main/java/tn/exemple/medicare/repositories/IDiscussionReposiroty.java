...
WHERE 
    (d.user1.id = :userId AND (d.deletedAtByUser1 IS NULL OR d.lastMessageTime > d.deletedAtByUser1))
 OR (d.user2.id = :userId AND (d.deletedAtByUser2 IS NULL OR d.lastMessageTime > d.deletedAtByUser2))
