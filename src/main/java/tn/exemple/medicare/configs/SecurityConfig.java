    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers( "/user/adduser", "/user/login" , "/user/activate-account" , "/user/forgot-password" , "/user/reset-password" , "/user/verify-code" , "/user/resend-code", "/medication/search","/medication/pagination",("/ws/**"))
